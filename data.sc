...
leftstring A63 = "# daily"
leftstring B63 = "mileage"
leftstring C63 = "[km]"
leftstring D63 = "..."
leftstring E63 = "..."
leftstring F63 = "..."
leftstring G63 = "..."
let H63 = (@nval("B",@myrow-2)-B2)/((@nval("A",@myrow-2)-A2)/24/3600)
...
leftstring F64 = "..."
leftstring G64 = "..."
let H64 = (@nval("H",@myrow-3)-H2)/((@nval("A",@myrow-3)-A2)/24/3600)*10000
fmt H64 "0"
goto E16 A0

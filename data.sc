...
leftstring A60 = "# daily"
leftstring B60 = "mileage"
leftstring C60 = "[km]"
leftstring D60 = "..."
leftstring E60 = "..."
leftstring F60 = "..."
leftstring G60 = "..."
let H60 = (@nval("B",@myrow-2)-B2)/((@nval("A",@myrow-2)-A2)/24/3600)
...
leftstring F61 = "..."
leftstring G61 = "..."
let H61 = (@nval("H",@myrow-3)-H2)/((@nval("A",@myrow-3)-A2)/24/3600)*10000
fmt H61 "0"
goto E58 A39
